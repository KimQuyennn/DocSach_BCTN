...
const HoSo = () => {
    ...
    const [avatarFrameUrl, setAvatarFrameUrl] = useState(null); // URL khung overlay
    ...
    useEffect(() => {
        if (userData?.AvatarFrame) {
            ...
            onValue(frameRef, (snapshot) => {
                ...
                if (data) setAvatarFrameUrl(data.ImageUrl);
            });
        } else {
    ...
    return (
        <ScrollView style={styles.container}>
            ...
            <View style={styles.actionSection}>
                ...
                <TouchableOpacity style={styles.avatarButton} onPress={pickImage}>
                    <View style={styles.avatarWrapper}>
                        {/* Ảnh avatar chính */}
                        <Image
                            source={{ uri: avatar || userData.Avatar }}
            ...
            <View style={styles.actionSection}>
                <TouchableOpacity
                    style={styles.buyFrameButton}
                    onPress={() => navigation.navigate('MuaKhungAvatar')}
                >
                    <Text style={styles.buyFrameButtonText}>Mua Khung Avatar</Text>
                </TouchableOpacity>
            </View>
